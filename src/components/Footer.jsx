                ...
                <div className="container mx-auto px-6 lg:px-20">
                    <div className="flex flex-col md:flex-row justify-between items-center gap-6">
                        <p className="text-gray-500 text-sm flex items-center gap-4">
                            <span>© 2026 Creovate AI. All rights reserved.</span>
                            <span className="text-[10px] text-gray-600 font-medium tracking-widest uppercase border-l border-white/10 pl-4">CEO : MEKD</span>
                        </p>
